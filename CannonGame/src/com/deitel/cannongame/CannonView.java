   ...
   implements SurfaceHolder.Callback
{
   ...
   private static final String GAMESCORE = "CanonGame";
   ...
   public static final int MAX_TARGET_PIECES = 9; // sections in the target
  ...
  MyIntComparator myC = new MyIntComparator();
   ...
   public CannonView(Context context, AttributeSet attrs)
   {
      ...
      savedScores = activity.getSharedPreferences(GAMESCORE, activity.MODE_PRIVATE); 
   ...
   private void getTop5Scores()
   {
	  ...
	  Map<String, Integer> scMap = (Map<String, Integer>) savedScores.getAll(); 
   ...
   private void addTop5Scores(List<Integer> sc)
   {
	   ...
	   SharedPreferences.Editor pEditor = savedScores.edit();
	   int sum = 0;
	   for (Integer s: sc)
	   {
		 sum ++;
   ...
   private void updatePositions(double elapsedTimeMS)
   {
            ...
            cannonball.y - cannonballRadius < target.end.y)
         {
               ...
               !hitStates[section])
            {
               ...
               if (++targetPiecesHit == TARGET_PIECES)
               {
                  ...
                  if (TARGET_PIECES == MAX_TARGET_PIECES)
                  {
      ...
      double blockerUpdate = interval * blockerVelocity * (1 + 2.0 * TARGET_PIECES/MAX_TARGET_PIECES);
      blocker.start.y += blockerUpdate;
      blocker.end.y += blockerUpdate;

      // update the target's position
      double targetUpdate = interval * targetVelocity * (1 + 2.0 * TARGET_PIECES/MAX_TARGET_PIECES);
   ...
   public void drawGameElements(Canvas canvas)
   {
      ...
      canvas.drawText(getResources().getString(
 	         R.string.score, score), 30, 50, textPaint);
      
      canvas.drawText(getResources().getString(
    	         R.string.game_level, TARGET_PIECES), 120, 50, textPaint);
      
      
      // display time remaining
      canvas.drawText(getResources().getString(
         R.string.time_remaining_format, timeLeft), 320, 50, textPaint);
      ...
      final DialogFragment gameResult = 
         new DialogFragment()
         {
            ...
            public Dialog onCreateDialog(Bundle bundle)
            {
            	...
            	//boolean bwin = (messageId == R.string.win);
            	
            	String strScore = "";
            	
            	int buttonType = R.string.reset_game;;
            	
            	if (messageId == R.string.win)
            		buttonType = R.string.next_level;
            	
            	if (messageId == R.string.end)
            	{
            		buttonType = R.string.quit;
              ...
              // create dialog displaying String resource for messageId
               ...
               builder.setMessage(getResources().getString(
                  R.string.results_format, shotsFired, totalElapsedTime) + " " + strScore);
               
               
               
               
               
               builder.setPositiveButton(buttonType,
